...
namespace Kairon {
    ...
    static ImGuiKey ImGui_KeyToImGuiKey(int key)
    {
        switch (key)
        {
	...
	void ImGuiLayer::OnEvent(Event& event)
	{
        ...
        dispatcher.Dispatch<MouseButtonReleasedEvent>(KR_BIND_EVENT_FN(ImGuiLayer::OnMouseButtonReleadesEvent));
        ...
        dispatcher.Dispatch<WindowResizeEvent>(KR_BIND_EVENT_FN(ImGuiLayer::OnWindowResizedEvent));
    ...
    bool ImGuiLayer::OnMouseButtonReleadesEvent(MouseButtonReleasedEvent& e)
    {
        ImGuiIO& io = ImGui::GetIO();
    ...
    {
        ImGuiIO& io = ImGui::GetIO();
        io.AddKeyEvent(ImGui_KeyToImGuiKey(e.GetKeyCode()), GLFW_RELEASE);
